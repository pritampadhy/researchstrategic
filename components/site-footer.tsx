  ...
  return (
    <footer className="border-t border-border py-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 px-5 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between lg:px-8">
        ...
        <div className="flex gap-5"><Link href="#research" className="hover:text-foreground">Research</Link><Link href="#workspace" className="hover:text-foreground">Try prototype</Link></div>
      </div>
    </footer>
  )
}
